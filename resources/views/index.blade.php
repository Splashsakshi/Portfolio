					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav justify-content-end">
							...
							<li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="	"
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class=""><i>I am'</i> <span class="multiText" style="
								color: #28a745;
					...
					<div class="col-lg-5" >
						...
						<img class="" src="img/banner/home-right.png" alt="" style="margin-top: 116px; margin-left: 125px;" id="div1">
	...
	<section class="about_area section_gap" id="about_us">
		<div class="container">
			<div class="row justify-content-start align-items-center">
				<div class="col-lg-5">
					<div class="about_img">
						<img class="" src="img/about-us.png" alt="" id="div2">
					</div>
				</div>
				...
				-lg-1 col-lg-5">
					<div class="main_title text-left">
						<h2>let’s <br>
							...
							myself</h2>
						<p>
							Greetings! I Am Sakshi and I am delighted to welcome you to my portfolio. As a Software Developer, I bring  1Year of experience and a passion for Database server.
						</p>
						<p>
							In my professional journey, I have done goverment projects like <i>Nagpur Mahametro, Mahagenco.</i> 
					...
					<div class="row">
						...
						{{-- <div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-brand-item d-table">
								<div class="d-table-cell text-center">
                                    <div id="container">
                                        <img src="img/brands/R.png" alt="" class="image">
                                      </div>
								</div>
							</div>
						</div>
                        <div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-brand-item d-table">
								<div class="d-table-cell text-center">
                                    <div id="container">
                                        <img src="img/brands/css.jpg" alt="" class="image">
                                      </div>
								</div>
							</div>
						</div>
                        <div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-brand-item d-table">
								<div class="d-table-cell text-center">
                                    <div id="container">
                                        <img src="img/brands/bootstrap.png" alt="" class="image">
                                      </div>
								</div>
							</div>
						</div>
                        <div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-brand-item d-table">
								<div class="d-table-cell text-center">
                                    <div id="container">
                                        <img src="https://e7.pngegg.com/pngimages/662/163/png-clipart-jquery-logo-web-development-jquery-ui-javascript-computer-icons-jqlogo-emblem-label.png" alt="" class="image">
                                      </div>
								</div>
							</div>
						</div> --}}
				...
				<div class="offset-lg-2 col-lg-4 col-md-6">
					<div class="client-info">
						<div class="d-flex mb-50">
							...
							<span class="smll">Year+ Experience Working</span>
						</div>
						<div class="call-now d-flex">
							...
							<div class="ml-20">
								<p>Contact on Mail</p>
								<h6>sakshisharma57543@gmail.com</h6>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row feature_inner">
				<div class="col-lg-4 col-md-6">
					<div class="feature_item">
						...
						<h4 style="color: black">Web developing</h4>
						<p>The coding and programming side of website production. When you learn web development, you might start out writing a simple page of HTML text and build up to creating more complex.</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="feature_item">
						<img src="img/services/s2.png" alt="">
						<h4 style="color: black">UI/ux design</h4>
				...
				<div class="col-lg-4 col-md-6">
					<div class="feature_item">
						...
						<p>   The three most common types of web design are static web design, dynamic web design, and eCommerce web design.   </p>
						<br><br>
					</div>
				</div>
				...
				<div class="col-lg-12">
					<div class="footer_top flex-column">
						<div class="footer_logo">
							...
							<h4 style="color: green">Follow Me</h4>
						</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<script>
		var typingEffect = new Typed(".multiText", {
			strings :["Sakshi Sharma","software Devloper"],
			loop : true,
			typeSpeed : 100,
			backDelay : 1500
		})
